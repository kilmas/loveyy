...
export default {
  data: function data () {
    return {
      ...
      icon: {url: 'http://www.netnook.cn/static/loveyy/airplane.png'},
      ...
      plvisible: false,
      pictureHtml: [
        '<br/><img style="width:100%" src="http://www.netnook.cn/static/loveyy/Wiseman/1.jpg">',
        '<br/><img style="width:100%" src="http://www.netnook.cn/static/loveyy/Wiseman/2.jpg">',
        '<br/><img style="width:100%" src="http://www.netnook.cn/static/loveyy/DaltonHighway/1.jpg">',
        '<br/><img style="width:100%" src="http://www.netnook.cn/static/loveyy/DaltonHighway/2.jpg">',
        '<br/><img style="width:100%" src="http://www.netnook.cn/static/loveyy/DaltonHighway/3.jpg">',
        '<br/><img style="width:100%" src="http://www.netnook.cn/static/loveyy/DaltonHighway/4.jpg">',
        '<br/><img style="width:100%" src="http://www.netnook.cn/static/loveyy/DaltonHighway/5.jpg">',
        '<br/><img style="width:100%" src="http://www.netnook.cn/static/loveyy/Wiseman/3.jpg">',
        '<br/><img style="width:100%" src="http://www.netnook.cn/static/loveyy/Wiseman/4.jpg">',
        '<br/><img style="width:100%" src="http://www.netnook.cn/static/loveyy/Fairbanks/1.jpg">',
        '<br/><img style="width:100%" src="http://www.netnook.cn/static/loveyy/Fairbanks/2.jpg">',
        '<br/><img style="width:100%" src="http://www.netnook.cn/static/loveyy/Fairbanks2/1.jpg">'
      ],
      carPic: [
  ...
  methods: {
    ...
    showPic (time, callback, point) {
      ...
      let seft = this
      seft.zoom = 12
      this.icon = {url: 'http://www.netnook.cn/static/loveyy/car.png'}
    ...
    makerF () {
      ...
      let seft = this
      setTimeout(function () {
        seft.icon = {url: 'http://www.netnook.cn/static/loveyy/airplane1.png'}
